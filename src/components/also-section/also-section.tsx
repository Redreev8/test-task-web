    ...
    return (
        <Section aria-labelledby="also-title">
            <Container className={ style['container'] }>
                <Card isTitle>
                    <Title level={2} id="also-title">Most important title on the page</Title>
                </Card>
                        ...
                        arr.map((el, i) => (
                            <li className={ style['item'] } key={ i }>
                                <Card className={ style['card'] } isText>
                                    <Title className={ style['card__title'] } level={3}>{ el.title }</Title>
                ...
                <Btn href="/contacts" isCard>Contact us</Btn>
            </Container>
        </Section>
    )
}
